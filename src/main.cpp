...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "PostCoin";
        CTransaction txNew;
        txNew.nTime = 1403865688;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1403865688;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 124741 : 216178;
/*
...
*/
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x9aac37eb7321dce8e7f83db3e7b8bfb210968c0db30bfaf16719c1c7e7a08f3e"));
...
unsigned char pchMessageStart[4] = { 0x50, 0x15, 0x66, 0xc4 };
